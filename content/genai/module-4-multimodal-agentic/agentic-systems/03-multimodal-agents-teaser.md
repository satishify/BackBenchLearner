...
Module 4 joins **vision** (4.1–4.2) with **agents** (4.3). A multimodal agent might: read a screenshot -> extract an error code -> call a runbook API -> propose a fix — with a human approval step.
