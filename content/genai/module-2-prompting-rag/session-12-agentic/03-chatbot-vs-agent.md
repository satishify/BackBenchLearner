...
- You can afford HITL on the risky subset.
...
- **Agent without receipts.** Users cannot tell what changed in CRM/email/bank.
- **No escalation path.** Agents that never hand off create support debt.
- **Wrong metric.** Optimizing chat CSAT while task success collapses.
